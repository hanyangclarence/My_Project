...
if __name__ == "__main__":
    ...
    for i in range(len(music_id_list)):
        ...
        full_description = ' <separation> ' + dance_description
    ...
    while count < end_idx:
        ...
        for prompt in text_prompt_full:
            print(f'\t\t{prompt}')

...
srun python train.py --stage train_music_motion -b configs/train_music_motion_ablation_3.yaml -r training_logs/2024-02-26T01-47-35_ablation_3/checkpoints/last.ckpt

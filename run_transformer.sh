...
srun python train.py --stage train_music_motion -b configs/train_music_motion_exp_11_2.yaml -r training_logs/2024-02-13T05-13-43_exp_11_2/checkpoints/last.ckpt

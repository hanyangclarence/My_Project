...
srun python train.py --stage train_music_motion -b configs/train_music_motion_exp_14_4.yaml -r training_logs/2024-02-14T09-28-55_exp_14_4/checkpoints/last.ckpt

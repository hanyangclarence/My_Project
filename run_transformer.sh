...
srun python train.py --stage train_caption -b configs/train_caption_exp_22_3.yaml -r training_logs/2024-02-24T01-44-36_exp_22_3/checkpoints/last.ckpt --mm_ckpt exp_checkpoint/pretrained.ckpt

...
srun python train.py --stage train_music_motion -b configs/train_music_motion_exp_14_2.yaml -r training_logs/2024-02-13T10-30-35_exp_14_2/checkpoints/last.ckpt

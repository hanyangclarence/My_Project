...
srun python train.py --stage train_caption -b configs/train_caption_exp_15.yaml -r training_logs/2024-02-20T04-41-07_exp_15/checkpoints/last.ckpt --mm_ckpt exp_checkpoint/pretrained.ckpt

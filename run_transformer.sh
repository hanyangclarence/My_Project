...
srun python train.py --stage train_music_motion -b configs/train_music_motion_ablation_4.yaml -r training_logs/2024-02-26T02-24-31_ablation_4/checkpoints/last.ckpt

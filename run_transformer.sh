...
srun python train.py --stage train_caption -b configs/train_caption_exp_22_2.yaml -r training_logs/2024-02-22T21-42-46_exp_22_2/checkpoints/last.ckpt --mm_ckpt exp_checkpoint/pretrained.ckpt

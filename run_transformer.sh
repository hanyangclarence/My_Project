...
srun python train.py --stage train_music_motion -b configs/train_music_motion_ablation_7.yaml -r training_logs/2024-03-03T06-38-38_ablation_7/checkpoints/last.ckpt

...
srun python train.py --stage train_music_motion -b configs/train_music_motion_ablation_2_2.yaml -r training_logs/2024-03-01T12-24-09_ablation_2_2/checkpoints/last.ckpt

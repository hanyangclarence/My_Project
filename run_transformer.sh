...
srun python train.py --stage train_caption -b configs/train_caption_exp_19.yaml -r training_logs/2024-02-18T21-23-02_exp_19/checkpoints/last.ckpt --mm_ckpt exp_checkpoint/pretrained.ckpt

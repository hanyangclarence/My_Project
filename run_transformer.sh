...
srun python train.py --stage train_music_motion -b configs/train_music_motion_ablation_6.yaml -r training_logs/2024-02-29T11-31-12_ablation_6/checkpoints/last.ckpt
